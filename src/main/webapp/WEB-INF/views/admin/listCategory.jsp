        ...
        <table id="categoryTable" class="table table-striped table-bordered table-hover  table-condensed">
            ...
            <c:forEach items="${categories}" var="c">
                ...
                <tr class="center">
                    ...
                    <td style="vertical-align: middle"><img class="min" height="40px"
                                                            src="${pageContext.request.contextPath}/img/category/${c.id}.jpg">
                    </td>
                    <td style="vertical-align: middle">${c.name}</td>
                    <td style="vertical-align: middle"><a href="listProperty?category_id=${c.id}"><span
                            class="glyphicon glyphicon-th-list"></span></a></td>
                    <td style="vertical-align: middle"><a href="listProduct?category_id=${c.id}"><span
                            class="glyphicon glyphicon-shopping-cart"></span></a></td>
                    <td style="vertical-align: middle"><a href="editCategory?id=${c.id}"><span
                            class="glyphicon glyphicon-edit"></span></a></td>
                    <td style="vertical-align: middle"><a class="category" href="deleteCategory?id=${c.id}"
                                                          cid="${c.id}"><span
