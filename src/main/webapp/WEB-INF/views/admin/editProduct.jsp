...
<jsp:include page="../include/admin/adminHeader.jsp">
    <jsp:param name="pageTitle" value="编辑产品"/>
</jsp:include>
...
<div class="workingArea">
    <ol class="breadcrumb">
        ...
        <li><a href="listProduct?category_id=${p.category_id}">${c.name}</a></li>
        ...
        <div class="panel-body">
            <form method="post" id="editForm" action="updateProduct">
                <table class="editTable">
                    ...
                    <tr>
                        <td>原价格</td>
                        <td><input id="originalPrice" value="${p.price}" name="price" type="text"
                                   class="form-control"></td>
                    </tr>
                    <tr>
                        <td>优惠价格</td>
