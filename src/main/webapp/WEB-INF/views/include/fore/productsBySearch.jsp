...
<div class="searchProducts">
    ...
    <div class="productUnit" price="${p.promotePrice}">
        <a href="foreproduct?product_id=${p.id}">
            <img class="productImage" src="${pageContext.request.contextPath}/img/productSingle/${p.firstImage.id}.jpg">
        </a>
        <span class="productPrice">¥<fmt:formatNumber type="number" value="${p.promotePrice}"
                                                      minFractionDigits="2"/></span>
        <a class="productLink" href="foreproduct?product_id=${p.id}">
                ${fn:substring(p.name, 0, 50)}
        </a>

        <a class="tmallLink" href="foreproduct?product_id=${p.id}">天猫专卖</a>
