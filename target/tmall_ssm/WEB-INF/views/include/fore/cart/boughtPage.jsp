			...
			<table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
				...
				<c:forEach items="${o.orderItem}" var="oi" varStatus="st">
					<tr class="orderItemProductInfoPartTR" >
						<td class="orderItemProductInfoPartTD"><img width="80" height="80" src="${pageContext.request.contextPath}/img/productSingle/${oi.product.firstImage.id}.jpg"></td>
						...
						<c:if test="${st.count==1}">
							...
							<td valign="top" rowspan="${fn:length(o.orderItem)}" class="orderListItemButtonTD orderItemOrderInfoPartTD" width="100px">
								...
								<c:if test="${o.status=='waitDelivery' }">
									<span>待发货</span>
 									<button class="btn btn-info btn-sm ask2delivery" link="admin/OrderDelivery?id=${o.id}">催卖家发货</button>
