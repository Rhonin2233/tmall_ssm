				...
				<c:forEach items="${ois }" var="oi">
					<tr oiid="${oi.id}" class="cartProductItemTR">
						<td>
							...
							<img class="cartProductImg"  src="${pageContext.request.contextPath}/img/productSingle/${oi.product.firstImage.id}.jpg">
						</td>
						<td>
