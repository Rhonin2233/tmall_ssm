...
<title>模拟天猫官网 提交订单</title>
<div class="buyPageDiv">
  <form action="checkcreateOrder" method="post">
		...
		<div>
			...
			<table class="addressTable">
				...
				<tr>
					...
					<td><input type="hidden" name="totalPrice" value="${total}">
						<input name="mobile"  placeholder="请输入11位手机号码" type="text"></td>
				</tr>
			</table>
			...
			<tbody class="productListTableTbody">
				<c:forEach items="${ois}" var="oi" varStatus="st" >
					<tr class="orderItemTR">
						<td class="orderItemFirstTD"><img class="orderItemImg" src="${pageContext.request.contextPath}/img/productSingle/${oi.product.firstImage.id}.jpg"></td>
