...
<div class="confirmPayPageDiv">
	<div class="confirmPayImageDiv">
		...
		<div class="confirmPayTime3">
			<fmt:formatDate value="${o.delivery_date}" pattern="yyyy-MM-dd HH:mm:ss"/>
		</div>
	...
	<div class="confirmPayOrderItemDiv">
		...
		<table class="confirmPayOrderItemTable">
			...
			<c:forEach items="${o.orderItem}" var="oi">
				<tr>
					<td><img width="50px" src="${pageContext.request.contextPath}/img/productSingle/${oi.product.firstImage.id}.jpg"></td>
					...
					<td><span class="text-muted">产品数量：${oi.number}个</span></td>
	...
	<div class="confirmPayOrderDetailDiv">
		...
		<table class="confirmPayOrderDetailTable">
			<tr>
				<td>订单编号：</td>
				<td>${o.order_code} <img width="23px" src="${pageContext.request.contextPath}/img/site/confirmOrderTmall.png"></td>
			</tr>
			<tr>
				<td>卖家昵称：</td>
			...
			<tr>
				<td>收货信息： </td>
				<td>地址：${o.address}，姓名：${o.receiver}，电话： ${o.mobile}，邮箱：${o.post} </td>
			</tr>
			<tr>
				<td>成交时间：</td>
	...
	<div class="confirmPayButtonDiv">
		...
		<a href="checkorderConfirmed?id=${o.id}"><button class="confirmPayButton">确认支付</button></a>
	</div>
</div>