        ...
        $.get(
                ...
                function(result){
                    if(result){
                        var pid = ${p.id};
                        var num= $(".productNumberSetting").val();
                        var addCartpage = "checkaddCart";
                        $.get(
                                addCartpage,
                                {"product_id":pid,"number":num},
                                function(result){
                                    if(result){
...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="${pageContext.request.contextPath}/img/productSingle/${p.firstImage.id}.jpg" class="bigImg">
        <div class="smallImageDiv">
            <c:forEach items="${p.productSingleImages}" var="pi">
                <img src="${pageContext.request.contextPath}/img/productSingle/${pi.id}.jpg" bigImageURL="img/productSingle/${pi.id}.jpg" class="smallImage">
            </c:forEach>
        </div>
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="buyDiv">
            <a class="buyLink" href="checkbuyone?product_id=${p.id}"><button class="buyButton">立即购买</button></a>
