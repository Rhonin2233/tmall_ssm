				...
				<tr>
					...
					<td style="vertical-align: middle;text-align: center">
						<c:if test="${!empty p.firstImage}">
							<img class="min" width="40px" src="${pageContext.request.contextPath}/img/productSingle/${p.firstImage.id}.jpg">
						</c:if>
					</td>
					...
					<td style="vertical-align: middle;text-align: center"><a href="editPropertyValue?product_id=${p.id}"><span
