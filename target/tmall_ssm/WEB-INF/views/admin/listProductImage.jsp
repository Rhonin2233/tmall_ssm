				...
				<div>
					<div class="panel panel-warning addPictureDiv">
						...
						<div class="panel-body">
							<form method="post" class="addFormSingle" action="addProductImage" enctype="multipart/form-data">
					...
					<table class="table table-striped table-bordered table-hover  table-condensed">
						...
						<c:forEach items="${ps}" var="pi">
							<tr>
								<td>${pi.id}</td>
								<td>
									<a title="点击查看大图" href="${pageContext.request.contextPath}/img/productSingle/${pi.id}.jpg"><img  height="50px" src="${pageContext.request.contextPath}/img/productSingle/${pi.id}.jpg"></a>
								</td>
			...
			<td class="addPictureTableTD">
				<div>
					...
					<div class="panel panel-warning addPictureDiv">
						...
						<div class="panel-body">
							<form method="post" class="addFormDetail" action="addProductImage" enctype="multipart/form-data">
								<table class="addTable">
									<tr>
					...
					<table class="table table-striped table-bordered table-hover  table-condensed">
						...
						<c:forEach items="${pd}" var="pi">
							<tr>
								<td>${pi.id}</td>
								<td>
									<a title="点击查看大图" href="${pageContext.request.contextPath}/img/productDetail/${pi.id}.jpg"><img  height="50px" src="${pageContext.request.contextPath}/img/productDetail/${pi.id}.jpg"></a>
								</td>
								<td><a deleteLink="true"
									   href="deleteProductImage?id=${pi.id}&type=${pi.type}&product_id=${pi.product_id}"><span
										class=" 	glyphicon glyphicon-trash"></span></a></td>
